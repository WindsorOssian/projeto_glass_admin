...
<aside class="sidebar" id="sidebar">
    ...
    <div class="sidebar-footer">
        <div class="user-profile">
            ...
            <div class="user-info">
                <div class="user-name">Redes Sociais</div>
                <div class="user-role">

                    <a href="https://wa.me/5543996814862?text=Olá!%20Gostaria%20de%20obter%20informações%20sobre%20o%20ID%20Preparatório%20de%20Concursos%20e%20como%20posso%20realizar%20minha%20inscrição."
                        target="_blank"
                        aria-label="WhatsApp">
                        <i class="fa-brands fa-whatsapp fa-2x"></i>
                    </a>

                    <a href="https://www.youtube.com/@id.preparatorio"
                        target="_blank"
                        aria-label="YouTube">
                        <i class="fa-brands fa-youtube fa-2x"></i>
                    </a>

                    <a href="https://www.instagram.com/id.preparatorio.cambe"
                        target="_blank"
                        aria-label="Instagram">
                        <i class="fa-brands fa-instagram fa-2x"></i>
                    </a>

                    <a href="https://www.facebook.com/IDpreparatoriodeconcursos/"
                        target="_blank"
                        aria-label="Facebook">
