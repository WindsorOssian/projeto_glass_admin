        ...
        <div class="login-container">
            <div class="login-card">
                <div class="login-header">
                    <div class="login-logo">ID</div>
                    <h1 class="login-title">Portal do Administrador</h1>
                    <p class="login-subtitle">Realize suas atividades aqui</p>
                </div>

                <form data-validate data-redirect="../../View/adm/inicial_adm.php">
                    <div class="form-group">
                        <label class="form-label" for="email">Seu Email</label>
                        <input name="email" type="email" id="email" class="form-input" placeholder="Digite aqui seu email" required>
                    </div>

                    <div class="form-group">
                        <label class="form-label" for="password">Sua Senha</label>
                        <input name="password" type="password" id="password" class="form-input" placeholder="Digite aqui sua senha" required>
                    </div>
                ...
                <!-- Login social, no caso seria logar com alguma rede tipo gmail. -->
                <!-- <div class="divider">
